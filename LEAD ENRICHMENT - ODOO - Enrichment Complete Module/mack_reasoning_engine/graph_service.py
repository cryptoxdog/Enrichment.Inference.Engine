...
class GraphService:
    ...
    def augment_matches(self, deterministic_matches: list, context) -> list:
        """
        ...
        _logger.info(f"Augmenting {len(deterministic_matches)} matches with AI insights")
        ...
        for match in deterministic_matches:
            ...
            graph_insights = self._get_graph_insights(adjusted_match.buyer_partner_id, context)
            ...
            if graph_insights["pattern_match_count"] > 0:
                adjusted_match.confidence = min(
                    1.0, adjusted_match.confidence + (graph_insights["pattern_match_count"] * 0.05)
                )
    ...
    def _get_successful_patterns(self, context) -> dict[str, Any]:
        ...
        if monthly_counts:
            patterns["timing_insights"] = {
                "busiest_months": sorted(monthly_counts.items(), key=lambda x: x[1], reverse=True)[
                    :3
                ]
            }
    ...
    def _get_graph_insights(self, buyer_partner_id: int, context) -> dict[str, Any]:
        """
    ...
    def _ai_extract_supplier_data(self, raw_data: dict[str, Any]) -> dict[str, Any]:
        """
        ...
        functions = [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "density": {"type": "number", "description": "Density in g/cm³"},
                        "melt_index": {
                            "type": "number",
                        ...
                        "color": {"type": "string", "description": "Material color"},
                        "confidence": {
                            "type": "number",
    ...
    def _rule_based_extract(self, raw_data: dict[str, Any], source_channel: str) -> dict[str, Any]:
        """
