...
from app.services.outcome_delegator import (
    parse_outcome_payload, build_corrective_request,
    _build_idempotency_key, _select_target_fields,
    _ELEVATED_CONSENSUS_THRESHOLD, _ELEVATED_MAX_VARIATIONS,
...
def test_parse_valid_payload():
    payload = {
        ...
        "verdict": "graph_rejected", "failed_gates": [],
    }
